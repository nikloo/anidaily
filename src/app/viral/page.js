...
export const metadata = {
  title: 'VIRAL News — Latest Viral Updates',
  description: 'Trending anime & manga moments, viral clips, memes and community highlights.',
  openGraph: { title: 'VIRAL News | AniDaily', description: 'Trending anime & manga moments, viral clips, memes and community highlights.' },
};

const DUMMY = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  title: `Viral News Story #${i + 1} — Breaking Update Today`,
  date: `${i + 1}h ago`,
  img: `https://picsum.photos/seed/viral${i}/600/400`,
    ...
    <>
      ...
      <main className="container" style={{ paddingTop: 32 }}>
        ...
        <nav className="breadcrumb" style={{ marginBottom: 16 }}>
          <Link href="/">Home</Link> › <span style={{ color: 'var(--viral-purple)' }}>VIRAL</span>
        </nav>

        {/* Header */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
          <div className="section-bar" style={{ background: 'var(--viral-purple)' }} />
          <h1 className="section-title">VIRAL NEWS</h1>
          <span className="section-jp">バイラル</span>
        </div>
        ...
        <div className="main-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 24 }}>
          ...
          <aside>
            ...
            <div className="manga-panel" style={{ background: 'var(--surface)', padding: 20 }}>
              ...
              <p style={{ fontSize: 12, color: 'var(--cream60)', lineHeight: 1.6, marginBottom: 14 }}>Get daily viral news in your inbox.</p>
