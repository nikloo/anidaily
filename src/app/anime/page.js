...
export const metadata = {
  ...
  description: 'Latest anime news, season announcements, episode reviews and streaming updates.',
  openGraph: { title: 'ANIME News | AniDaily', description: 'Latest anime news, season announcements, episode reviews and streaming updates.' },
};

const DUMMY = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  title: `Anime News Story #${i + 1} — Breaking Update Today`,
  date: `${i + 1}h ago`,
  img: `https://picsum.photos/seed/anime${i}/600/400`,
    ...
    <>
      ...
      <main className="container" style={{ paddingTop: 32 }}>
        ...
        <nav className="breadcrumb" style={{ marginBottom: 16 }}>
          <Link href="/">Home</Link> › <span style={{ color: 'var(--red)' }}>ANIME</span>
        </nav>

        {/* Header */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
          <div className="section-bar" style={{ background: 'var(--red)' }} />
          <h1 className="section-title">ANIME NEWS</h1>
          <span className="section-jp">アニメ</span>
        </div>
        ...
        <div className="main-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 24 }}>
          ...
          <aside>
            ...
            <div className="manga-panel" style={{ background: 'var(--surface)', padding: 20 }}>
              ...
              <p style={{ fontSize: 12, color: 'var(--cream60)', lineHeight: 1.6, marginBottom: 14 }}>Get daily anime news in your inbox.</p>
