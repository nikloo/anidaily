...
export const metadata = {
  title: 'TCG News — Latest Tcg Updates',
  description: 'TCG card prices, set reveals, meta analysis and tier lists for Pokémon, One Piece, Yu-Gi-Oh and more.',
  openGraph: { title: 'TCG News | AniDaily', description: 'TCG card prices, set reveals, meta analysis and tier lists for Pokémon, One Piece, Yu-Gi-Oh and more.' },
};

const DUMMY = Array.from({ length: 8 }, (_, i) => ({
  id: i + 1,
  title: `Tcg News Story #${i + 1} — Breaking Update Today`,
  date: `${i + 1}h ago`,
  img: `https://picsum.photos/seed/tcg${i}/600/400`,
    ...
    <>
      ...
      <main className="container" style={{ paddingTop: 32 }}>
        ...
        <nav className="breadcrumb" style={{ marginBottom: 16 }}>
          <Link href="/">Home</Link> › <span style={{ color: 'var(--tcg-gold)' }}>TCG</span>
        </nav>

        {/* Header */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
          <div className="section-bar" style={{ background: 'var(--tcg-gold)' }} />
          <h1 className="section-title">TCG NEWS</h1>
          <span className="section-jp">カードゲーム</span>
        </div>
        ...
        <div className="main-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 24 }}>
          ...
          <aside>
            ...
            <div className="manga-panel" style={{ background: 'var(--surface)', padding: 20 }}>
              ...
              <p style={{ fontSize: 12, color: 'var(--cream60)', lineHeight: 1.6, marginBottom: 14 }}>Get daily tcg news in your inbox.</p>
